...
class _HomeState extends State<Home> with SingleTickerProviderStateMixin {
  ...
  Future<void> _submitForm() async {
    if (_formKey.currentState!.validate()) {
      ...
      final response = await http.post(
        Uri.parse('https://coherent-welcomed-snipe.ngrok-free.app/predict'),
  ...
  Widget _buildDropdownField(
      String labelText, String? value, void Function(String?) onChanged) {
    return Container(
      width: 300,
      margin: EdgeInsets.symmetric(vertical: 8.0),
      decoration: BoxDecoration(
                  ...
                  Form(
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        _buildDropdownField(
                            'Change of Diabetes Medication', _changeValue,
                            (value) {
                          setState(() {
                            _changeValue = value;
                          });
                        ...
                        _buildDropdownField(
                            'Diabetes Medication', _diabetesMedValue, (value) {
                          setState(() {
